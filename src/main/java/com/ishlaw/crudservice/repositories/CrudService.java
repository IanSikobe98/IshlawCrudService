...
public interface CrudService {
     ...
     * @return List of results or empty list if none is found.
     */
    public ReportResponse fetchWithNativeQueryResultMapPageable(String query, String qcount, String mapperName, Map<String, Object> params, int pageNumber, int pageSize) throws HibernateException;
